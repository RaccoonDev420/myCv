...
import profilePicture from './img/valin.jpg';
import sunPicture from './img/sun.jpg';
import asteroidPicture from './img/asteroid.jpg';
import asteroidMap from './img/asteroidMap.jpg';
import spacePicture from './img/space.jpg';
import sunMap from './img/sunMap.jpg';
import venusPicture from './img/venus.jpg';
import venusMap from './img/venusMap.jpg';
import mercuryPicture from './img/mercury.jpg';
import mercuryMap from './img/mercuryMap.jpg';
import earthPicture from './img/earth.jpg';
import earthMap from './img/earthMap.jpg';
import moonPicture from './img/moon.jpg';
import moonMap from './img/moonMap.jpg';
import marsPicture from './img/mars.jpg';
import marsMap from './img/marsMap.jpg';
import jupiterPicture from './img/jupiter.jpg';
import jupiterMap from './img/jupiterMap.jpg';
import saturnPicture from './img/saturn.jpg';
import saturnMap from './img/saturnMap.jpg';
import saturnRingPicture from './img/saturn_ring.png';
import saturnRingMap from './img/saturnRingMap.jpg';
import uranusPicture from './img/uranus.jpg';
...
const salmeTexture = new THREE.TextureLoader().load(profilePicture);
...
function addAsteroids() {
    ...
    const texture = new THREE.TextureLoader().load(asteroidPicture);
    const NormalTexture = new THREE.TextureLoader().load(asteroidMap);
...
const spaceTexture = new THREE.TextureLoader().load(spacePicture);
scene.background = spaceTexture;



//sun 
const sunTexture = new THREE.TextureLoader().load(sunPicture);
const sunNormalTexture = new THREE.TextureLoader().load(sunMap);
...
//Mercury
const mercuryTexture = new THREE.TextureLoader().load(mercuryPicture);
const mercuryNormalTexture = new THREE.TextureLoader().load(mercuryMap);
...
//Venus
const venusTexture = new THREE.TextureLoader().load(venusPicture);
const venusNormalTexture = new THREE.TextureLoader().load(venusMap);
...
//Earth
const earthTexture = new THREE.TextureLoader().load(earthPicture);
const earthNormalTexture = new THREE.TextureLoader().load(earthMap);
...
const moonNormalTexture = new THREE.TextureLoader().load(moonMap);
...
//Mars
const marsTexture = new THREE.TextureLoader().load(marsPicture);
const marsNormalTexture = new THREE.TextureLoader().load(marsMap);
...
//Jupiter
const jupiterTexture = new THREE.TextureLoader().load(jupiterPicture);
const jupiterNormalTexture = new THREE.TextureLoader().load(jupiterMap);
...
//Saturn
const saturnTexture = new THREE.TextureLoader().load(saturnPicture);
const saturnNormalTexture = new THREE.TextureLoader().load(saturnMap);
...
const ringTexture = new THREE.TextureLoader().load(saturnRingPicture);
const ringNormalTexture = new THREE.TextureLoader().load(saturnRingMap);
...
//Uranus
const uranusTexture = new THREE.TextureLoader().load(uranusPicture);
const uranusNormalTexture = new THREE.TextureLoader().load(uranusMap);
